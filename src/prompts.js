...
5. KHÔNG thực hiện bất kỳ action nào ngoài scope: task management (CAPTURE, BACKLOG, BACKLOG_BROWSE, TRIAGE, UPDATE, REPORT, LOAD_CHECK, OVERDUE_CHECK)
...
{
  "intent": "CAPTURE|BACKLOG|BACKLOG_BROWSE|TRIAGE|OVERDUE_CHECK|UPDATE|REPORT|LOAD_CHECK|CLARIFY",
  ...
  "notion_action": null | {
    ...
    "data": {
      ...
      // "new_status": "Completed" (DB chỉ có: To do, In progress, Pending / Wait for approved, Completed)
      // For QUERY:
